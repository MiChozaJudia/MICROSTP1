...
/**
 * @brief Pauses and starts the corresponding timer
 * @param id ID of the timer to toggle
 */
void timerToggle(tim_id_t id);


/**
 * @brief Amount of active timers
 */
tim_id_t timersActive(void);

/**
 * @brief Announces if specified timer is available
 */
